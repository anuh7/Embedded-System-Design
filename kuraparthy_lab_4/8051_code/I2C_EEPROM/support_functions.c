 ...
 * Attributions: sdcc_syntax_example.c given in class
 --------------------------------------------------------------------------------
 * This c file contains functions to initialise serial communication, get and print characters and strings
 * via the PC terminal emulator scren
   ---------------------------------------------------------------------------------*/
...
{
    if (address >=0x00 && address<0x8000)           //eeprom address rangle
    {
        return 1;
    }
    else
